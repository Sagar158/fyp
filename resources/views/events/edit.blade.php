            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <form action="{{route('event.update',['eventId' => $event->id])}}" method="POST" enctype="multipart/form-data">
                            {{@csrf_field()}}
                            ...
                            <div class="card row mt-2">
                                    ...
                                    <select name="promo_id" class="form-control @error('promo_id') is-invalid @enderror">
                                        ...
                                        @if(!empty($promotions))
                                            @foreach($promotions as $promotion)
                                                <option value="{{$promotion->id}}" {{$promotion->id == $event->promo_id ? 'selected' : ''}}>{{$promotion->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('promo_id')
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 mt-1">
                                    ...
                                    <input type="text" autocomplete="off" name="title" class="form-control @error('title') is-invalid @enderror" value="{{$event->title}}" placeholder="{{trans('general.enter_title')}}">
                                    @error('title')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 mt-1">
                                    ...
                                    <input type="text" autocomplete="off" name="location" class="form-control @error('location') is-invalid @enderror" value="{{$event->location}}" placeholder="{{trans('general.enter_location')}}">
                                    @error('location')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-lg-12 col-sm-12 col-md-12 mt-1">
                                    ...
                                    <div class="input-group" id="datepicker1">
                                        <input type="text" class="form-control @error('from') is-invalid @enderror" name="from" placeholder="dd M, yyyy"
                                            data-date-format="dd M, yyyy" data-date-autoclose="true" data-date-container='#datepicker1' data-provide="datepicker" autocomplete="off" value="{{$event->from}}">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 mt-1">
                                    ...
                                    <div class="input-group" id="datepicker1">
                                        <input type="text" class="form-control @error('to') is-invalid @enderror" name="to" placeholder="dd M, yyyy"
                                            data-date-format="dd M, yyyy" data-date-autoclose="true" data-date-container='#datepicker1' data-provide="datepicker" autocomplete="off" value="{{$event->to}}">
                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                    </div>
                                    @error('to')
                                        <div class="text-danger mt-1">{{ $message }}</div>
